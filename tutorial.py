...
mnist_test_dataset = torchvision.datasets.MNIST('data', train=False, download=True, transform=transform)
print(mnist_train_dataset.targets)
idx = (mnist_train_dataset.targets==0) | (mnist_train_dataset.targets==1)
idx2 = (mnist_test_dataset.targets==0) | (mnist_test_dataset.targets==1)

mnist_train_dataset.targets = mnist_train_dataset.targets[idx]
mnist_train_dataset.data = mnist_train_dataset.data[idx]
...
pool = snn.Pooling(kernel_size = 3, stride = 1)
