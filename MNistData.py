...
for t in glob.glob('MSTAR/TARGETS/TRAIN/17_DEG/BMP2/SN_9563/*'):
    ...
    #print(fName)
    os.system('mstar2jpeg/mstar2jpeg -i '+t+' -o mstardataset/train/SN_9563/'+fName)
    # load in for 64x64
...
for t in glob.glob('MSTAR/TARGETS/TEST/15_DEG/BMP2/SN_9563/*'):
    fName = ((t.split('/')[-1])).split('.')[0] +'.jpeg'
    #print(fName)
    os.system('mstar2jpeg/mstar2jpeg -i '+t+' -o mstardataset/test/SN_9563/'+fName)
    # load in for 64x64
...
for t in glob.glob('MSTAR/TARGETS/TRAIN/17_DEG/BTR70/SN_C71/*'):
    ...
    fName = ((t.split('/')[-1])).split('.')[0] +'.jpeg'
    #print(fName)
    os.system('mstar2jpeg/mstar2jpeg -i '+t+' -o mstardataset/train/SN_C71/'+fName)
        # load in for 64x64
...
for t in glob.glob('MSTAR/TARGETS/TEST/15_DEG/BTR70/SN_C71/*'):
    fName = ((t.split('/')[-1])).split('.')[0] +'.jpeg'
    #print(fName)
    os.system('mstar2jpeg/mstar2jpeg -i '+t+' -o mstardataset/test/SN_C71/'+fName)
        # load in for 64x64
